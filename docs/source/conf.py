...
Copyright
    ...
    samba_manager is distributed in the hope that it will be useful, but
...
project: str = 'samba_manager'
project_copyright: str = '2026, Vladimir Roncevic <elektron.ronca@gmail.com>'
author: str = 'Vladimir Roncevic <elektron.ronca@gmail.com>'
version: str = '3.0'
release: str = 'https://github.com/vroncevic/samba_manager/releases'
...
htmlhelp_basename: str = 'samba_managerdoc'
latex_elements: Dict[Any, Any] = {}
latex_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'samba_manager.tex', 'samba_manager Documentation',
    'Vladimir Roncevic \\textless{}elektron.ronca@gmail.com\\textgreater{}',
    'manual'
)]
man_pages: List[Tuple[Any, ...]] = [(
    master_doc, 'samba_manager', 'samba_manager Documentation', [author], 1
)]
texinfo_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'samba_manager', 'samba_manager Documentation', author,
    'samba_manager', 'One line description of project.', 'Miscellaneous'
)]
